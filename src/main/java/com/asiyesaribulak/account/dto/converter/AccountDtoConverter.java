...
public class AccountDtoConverter {
    ...
    public AccountDtoConverter(CustomerDtoConverter customerDtoConverter, TranscationDtoConverter transcationDtoConverter) {
    ...
    public AccountDto convert(Account from){
        return new AccountDto(from.getId(),
                ...
                customerDtoConverter.accountCustomerDtoConvert(Optional.ofNullable(from.getCustomer())),
                Objects.requireNonNull(from.getTranscation())
                        .stream()
